...
module.exports = (function () {
    return {
        ':tell': function (speechOutput,directives) {
        ...
        ':ask': function (speechOutput, repromptSpeech,directives) {
            if(this.isOverridden()) {
                return;
            }
            this.handler.response = buildSpeechletResponse({
        ...
        ':askWithCard': function(speechOutput, repromptSpeech, cardTitle, cardContent, imageObj,directives) {
            if(this.isOverridden()) {
                return;
            }
        ...
        ':tellWithCard': function(speechOutput, cardTitle, cardContent, imageObj,directives) {
            if(this.isOverridden()) {
                return;
            }
